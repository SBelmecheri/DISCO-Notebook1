...
ts.plot(TR13.ts,ylab="d13C (permill.VPDB)",xlab="Years",xlim=c(1900,1960), col="#9C964A",lty=1, lwd=2)
...
gridded.vpd.data <- ts(read.csv("CRU_VPD.txt",header=F, skip=3),start=1901,frequency=1)
