...
# to a pre-industrial standard value of 6.5 permill i.e. remove the trend of 13C that result from a decline due to the Suess effect.
...
These signals are related to tree physiological response to these environmental variables as was reviewed in the stable isotope theory lectures.
...
# Note you can rerun this function and set the plot.it argument as TRUE. This will allow you top see plots generated for the various steps of the PIN calculation. You will need to hit return multiple times.
```
