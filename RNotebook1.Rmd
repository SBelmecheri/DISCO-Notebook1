...
The following code and comments should further your experience to analyze/treat tree ring d13C data (including atmosphere and climate data) using R.
This exercise relies upon raw tree-ring d13C measurements, atmospheric d13C measurements and instrumental climate data.
...
Tree-ring raw d13C data have a trend related to a decline in atmospheric d13C related to burning of fossil fuels (enriched in 12C).
This trend or effect is termed Suess Effect (Keeling, 1979) and should be removed before analyzing climate or ecophysiology of a tree ring d13C chronology.
